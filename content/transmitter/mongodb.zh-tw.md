...
services:
   gravity-transmitter-mongodb:
     image: "brobridgehub/gravity-transmitter-mongodb:v3.0.0"
     ...
     environment:
       ...
       # 目標資料庫的連線資訊
       GRAVITY_TRANSMITTER_MONGODB_DATABASE_HOST: 172.17.0.1
       GRAVITY_TRANSMITTER_MONGODB_DATABASE_PORT: 5432
       GRAVITY_TRANSMITTER_MONGODB_DATABASE_USERNAME: mongodb
       GRAVITY_TRANSMITTER_MONGODB_DATABASE_PASSWORD: 1qaz@WSX
       GRAVITY_TRANSMITTER_MONGODB_DATABASE_DBNAME: gravity
